...
void iUpmObject::initFromJsonLibDesc(const char *path_to_json_file)
{
    /* First, convert to a realpath */
    std::string realpath_json_file = realpath(path_to_json_file, NULL);
